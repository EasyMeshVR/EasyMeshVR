...
namespace VRKeys {
	...
	public class Keyboard : MonoBehaviour {
		...
		public Vector3 XRRigOffset = Vector3.zero;
		...
		private void Update () {
			...
			leftHand.transform.localPosition = InputTracking.GetLocalPosition (XRNode.LeftHand) + XRRigOffset;
			leftHand.transform.localRotation = InputTracking.GetLocalRotation (XRNode.LeftHand);

			rightHand.transform.localPosition = InputTracking.GetLocalPosition (XRNode.RightHand) + XRRigOffset;
		...
		private void PositionAndAttachMallets () {
			...
			transform.localPosition = positionRelativeToUser + XRRigOffset;
